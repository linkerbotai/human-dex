...
LEFT_HAND_JOINT_L20 = 16 # L20手左手关节数
RIGHT_HAND_JOINT_L20 = 16 #L20手右手关节数
...
TASK_CONFIGS = {
    ...
    # },
    'data_wawa_grasp': {
        'dataset_dir': '/home/moning/dataset/20250104/linker_palmgrasp_hdf5',
        'camera_names': ['cam_top', 'cam_left'],
        'observation_name': ['qpos', 'hand_action'],
        'num_episodes': 100,
        'episode_len': 1000,
        'joint_total': 22,
